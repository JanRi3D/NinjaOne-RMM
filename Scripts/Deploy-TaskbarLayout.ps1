...
try {
    ...
    Write-Output "Taskbar layout deployed successfully"
    Write-Output "Icons have been copied to: $iconsDir"
    Write-Output "Shortcuts have been updated with local icons"
    exit 0
